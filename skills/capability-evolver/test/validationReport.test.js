...
describe("isValidValidationReport", function () {
  ...
  it("returns false for wrong type field", function () {
    assert.equal(
      isValidValidationReport({ type: "Other", id: "x", commands: [], overall_ok: true }),
      false,
    );
  });
  ...
  it("returns false for missing id", function () {
    assert.equal(
      isValidValidationReport({ type: "ValidationReport", commands: [], overall_ok: true }),
      false,
    );
  });
  ...
  it("returns false for missing commands", function () {
    assert.equal(
      isValidValidationReport({ type: "ValidationReport", id: "x", overall_ok: true }),
      false,
    );
  });
  ...
  it("returns false for missing overall_ok", function () {
    assert.equal(
      isValidValidationReport({ type: "ValidationReport", id: "x", commands: [] }),
      false,
    );
  });
});
