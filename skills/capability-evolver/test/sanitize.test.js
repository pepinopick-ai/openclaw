...
assert.ok(
  redactString("ghp_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx1234").includes(REDACTED),
...
assert.ok(
  redactString("github_pat_abcdefghijklmnopqrstuvwxyz123456").includes(REDACTED),
  "github_pat_ token should be redacted",
);
assert.ok(
  redactString("use ghs_abcdefghijklmnopqrstuvwxyz1234567890 for auth").includes(REDACTED),
